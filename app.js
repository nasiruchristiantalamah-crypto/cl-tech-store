...
async function placeOrder() {
  ...
  sendWA(order);         // notify store owner
  sendCustomerReceipt(order); // send receipt to customer
  ...
  document.getElementById('checkoutBody').innerHTML = `
    <div class="success-wrap">
      ...
      <p style="color:var(--green);font-weight:500">📱 A WhatsApp receipt has been sent to <strong>${esc(phone)}</strong></p>
      <p style="font-size:12px;color:var(--text3);margin-top:.25rem">
        If you don't receive it, check that your WhatsApp number is correct or contact us directly.
      </p>
